...
export default function Page() {
  ...
  const heroLogoSrc = "/TC%20Logo%27s/TrophyCast_Horizontal_Side_FullColor_transparent.png";
  ...
  return (
    <>
          ...
          <div className="flex flex-col items-center gap-6 text-center">
            <div className="relative flex justify-center">
              <Image
                ...
                height={480}
                priority
                className="relative h-auto w-full max-w-[280px] drop-shadow-2xl sm:max-w-[420px] lg:max-w-[560px]"
              />
            </div>
      ...
      {/* ── Gold divider ─────────────────────────────────────── */}
      <div className="gold-divider" />import Image from "next/image";
import { CTAButton } from "@/components/CTAButton";
import { Container } from "@/components/Container";
import { Icon } from "@/components/Icon";
import { ScreenshotGrid } from "@/components/ScreenshotGrid";
