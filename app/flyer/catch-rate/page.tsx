...
/**
 * Catch Rate Tournament — Half-Sheet How-To Flyer (TLO Event 9, Aug 12 2026 — Chatfield)
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginBottom: 12 }}>
            <div className="event-label" style={{ color: TEAL, fontSize: 10, fontWeight: 700, letterSpacing: '0.14em', textTransform: 'uppercase', marginBottom: 4 }}>
              Tightline Outdoors · Catch Rate Series · Event 9 of 10 · Aug 12 · Beat Nate in Walleye
            </div>
