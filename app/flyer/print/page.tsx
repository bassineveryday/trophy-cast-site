        ...
        <div style={{ padding: '6px 20px 4px', display: 'flex', flexDirection: 'column', background: CREAM }}>
          ...
          {[
            ...
            <div key={f.num} style={{
              ...
              paddingBottom: i < arr.length - 1 ? 3 : 0,
              marginBottom: i < arr.length - 1 ? 3 : 0,
          ...
          <div style={{
            ...
            <p style={{ fontSize: 8.5, fontWeight: 900, color: NAVY, letterSpacing: '0.12em', textTransform: 'uppercase', margin: '0 0 4px' }}>
              Also built in
            </p>
