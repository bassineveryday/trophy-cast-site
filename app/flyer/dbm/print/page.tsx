  ...
  return (
    <>
      ...
      >
        ...
        <div>Print one 11 × 8.5 landscape page at 100% scale or Actual Size, then cut once down the center.</div>
...
function PortraitHalfFlyer() {
  return (
    ...
    >
      ...
      >
        <div style={{ color: COLORS.blue, fontSize: 14, fontWeight: 900 }}>Meetings</div>
        <div style={{ textAlign: 'center', color: COLORS.ink, fontSize: 12.5, fontWeight: 700, whiteSpace: 'nowrap' }}>First Wednesday · 7:00 PM</div>
        <div style={{ textAlign: 'right', color: COLORS.blue, fontSize: 12, fontWeight: 700, whiteSpace: 'nowrap' }}>Bass Pro Shops Denver</div>
      </div>

      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', columnGap: 8, rowGap: 8, marginTop: 8, alignContent: 'start' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 108px', gap: 10, marginTop: 10, flex: 1, alignItems: 'start' }}>
      ...
      <div style={{ marginTop: 8, paddingTop: 6, borderTop: `1px solid ${COLORS.line}` }}>
      ...
      <div style={{ height: 4, width: '100%', background: COLORS.green, borderRadius: 999, marginTop: 8 }} />
    </div>
  );
}
