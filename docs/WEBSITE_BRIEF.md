...
| **Curious angler**                 | What makes Trophy Cast different?                        | Voice-first TC Coach logging, community focus, not just a fish tracker |
...
- TC Coach is identified by the sparkle mark.
- Sparkles tied to TC Coach should always render in **Trophy Gold** (`#D4AF37`).
- Do not use blue/electric sparkles for TC Coach surfaces.
- If a sparkle appears in the marketing UI, it should imply TC Coach assistance, not a generic decorative accent.
...
| Your data                   | Our data                      |
| Coach insights              | Generic predictions           |
...
| 2   | **Catch Logging (Voice + TC Coach)** | Conversational helper, photo           | "Log with your voice – game changer"  |
