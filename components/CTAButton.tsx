...
const variantClasses: Record<CTAButtonVariant, string> = {
  primary:
    "bg-trophyGold text-midnight hover:bg-white hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(212,175,55,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.4)] focus-visible:outline-trophyGold px-5 py-2 text-sm font-bold tracking-wide",
  secondary:
    "bg-white/5 text-copyLight border border-white/10 hover:bg-white/10 hover:border-white/30 focus-visible:outline-copyLight px-5 py-2 text-sm backdrop-blur-sm",
  ghost:
