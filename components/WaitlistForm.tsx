  ...
  if (status === "success") {
    return (
      <div className="flex flex-col items-center gap-4 py-10 text-center">
        <Image src="/trophy-cast-logo-256.png" alt="Trophy Cast" width={72} height={72} className="opacity-90" />
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto flex w-full max-w-md flex-col gap-5">
      ...
      <div className="flex flex-col items-center gap-2 pb-2">
        <Image src="/trophy-cast-logo-256.png" alt="Trophy Cast" width={64} height={64} className="opacity-90" />
